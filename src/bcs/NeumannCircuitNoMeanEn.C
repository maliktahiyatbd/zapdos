...
NeumannCircuitNoMeanEn::NeumannCircuitNoMeanEn(const InputParameters & parameters) :
...
Real
NeumannCircuitNoMeanEn::computeQpResidual()
{
...
Real
NeumannCircuitNoMeanEn::computeQpJacobian()
{
...
Real
NeumannCircuitNoMeanEn::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _em_id)
  {
...
Real
NeumannCircuitNoMeanEn::computeQpNonlocalJacobian(dof_id_type dof_index)
{
...
Real
NeumannCircuitNoMeanEn::computeQpNonlocalOffDiagJacobian(unsigned int jvar, dof_id_type dof_index)
{
