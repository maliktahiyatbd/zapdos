...
validParams<CircuitDirichletPotential>()
{
  ...
  p.addRequiredParam<std::string>("surface", "Whether you are specifying the potential on the "
  ...
  p.addParam<Real>("A", 1., "For 1D calculations, an area has to be passed. This area also must "
